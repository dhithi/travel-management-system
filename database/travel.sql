...
('Adhithi', 'Krish', 'adhithi3@gmail.com', 'Honnavar', 2147483647, 'Goa'),
('Preethi', 'Kanha', 'preethi5@gmail.com', 'Honnavar', 845868956, 'Mumbai');
...
INSERT INTO `payment` (`name`,`email`,`address`,`city`,`state`,`zip`,'cardholder','cardnumber','expmonth','expyear','cvv')
 VALUES
('Adhithi','adhithi3@gmail.com', 'Radhainagar','Kattankulathur','Tamilnadu',603209,'Adhithi', 1234123412341234,12,2024,332);
...
('Adi','Aditya','adityag45@gmail.com','s#ty%&*');
-- --------------------------------------------------------
